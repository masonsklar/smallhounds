...
function create() {
	...
	frontPlant = this.add.sprite(0, 1010, 'plantcycleatlas', '0').setOrigin(0).setInteractive(frontPlantPolygon, Phaser.Geom.Polygon.Contains).setScale(0.5);
